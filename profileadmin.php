...
<div>
	<div id ="profile">
		<?php if(isset($_SESSION['profileadmin'])) : 
	...
	<h6><a href="thaydoi.php" data-toggle="modal" data-target="#myModal1"><i class="fas fa-user-edit"></i>Cập nhật thông tin cá nhân</a></h6>
  	<table>
		<thead>
			<tr>
				<th>Mã ADMIN: </th>
				<th><?php echo $data['matk']?><?php $s = sprintf('%04d', $data['MaAdmin']); echo $s;?></th>
			</tr>
			<tr>
				<th>Họ và tên: </th>
      ...
      <div class="modal-content">
        ...
        <form action="thaydoi.php" method = "POST">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					<label>Họ Tên</label>
					<input type="text" class="form-control" placeholder="" name = "hoten" value = "<?php echo $_SESSION['profileadmin']['HoTen'];?>">
				</div> <!-- form-group end.// -->
				<div class="form-row">
					<div class="form-group col-md-6">
					<label>Ngày sinh</label>
					<input type="date" class="form-control" name = "ngaysinh" value = "<?php echo $_SESSION['profileadmin']['NgaySinh'];?>">
					</div> <!-- form-group end.// -->
					<div class="form-group col-md-6">
					<label>CMND/CCCD</label>
					<input type="text" class="form-control" name = "cccd" value = "<?php echo $_SESSION['profileadmin']['CMND'];?>">
					</div> <!-- form-group end.// -->
				</div> <!-- form-row.// -->
				<div class="form-group">
				<?php if($_SESSION['profileadmin']['GioiTinh'] == "Nam") :?>
				...
				<div class="form-row">
					<div class="form-group col-md-6">
					<label>Địa chỉ</label>
					<input type="text" class="form-control" name = "diachi" value = "<?php echo $_SESSION['profileadmin']['DiaChi'];?>">
					</div> <!-- form-group end.// -->
					<div class="form-group col-md-6">
					<label>Số điện thoại</label>
					<input type="text" class="form-control" name = "sdt" value = "<?php echo $_SESSION['profileadmin']['SDT'];?>">
					</div> <!-- form-group end.// -->
				</div> <!-- form-row.// -->
				<div class="form-group">
					<label>Email</label>
					<input type="email" class="form-control" placeholder="" name ="email" value = "<?php echo $_SESSION['profileadmin']['Email'];?>">
