        ...
        <form method="POST" action="">
            ...
            <div class="form-row">
                ...
                <select id="inputState" class="form-control" name ="hocki">
                    ...
                    <option value="HK4" >Học kì 4</option>
                    <option value="HK5" >Học kì 5</option>
                    <option value="HK6" >Học kì 6</option>
                    <option value="HK7" >Học kì 7</option>
                    <option value="HK8" >Học kì 8</option>
                    <option value="HK9" >Học kì 9</option>
                </select>
                </div> <!-- form-group end.// -->
            </div> <!-- form-row.// -->
            <div class="form-group">
