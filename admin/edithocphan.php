...
$idlich = $_GET['mahp'];
$locsql = "SELECT dsmonhoc.* , lichhoc.*, dstiethoc.*, thungay.*, dsphonghoc.*, dsgiaovien.* FROM lichhoc 
...
INNER JOIN dsphonghoc ON lichhoc.idphong = dsphonghoc.idphong WHERE `idlichhoc` = '".$idlich."'";
if(isset($_POST['save']))
{
...
?>
<div class="container">
<a href="listhocphan.php" class="btn btn-primary"><i class="fas fa-undo-alt"></i> Quay lại</a>
    <div class="row justify-content-center">
    
        <div class="col-md-6">
        <div class="card">
        <header class="card-header">
        <h4 class="card-title mt-2">Chỉnh sửa Lịch Học Phần</h4>
        </header>
        ...
        <form method="POST" action="">
            ...
            <label>Môn Học</label>
                <select id="inputState" class="form-control" name ="mamonhoc">
                    <option value="<?php echo $ketqua['MaMonHoc']?>" disabled selected><?php echo $ketqua['TenMonHoc']?></option>
                    <?php
            ...
            <label>Thứ?</label>
                <select id="inputState" class="form-control" name ="thu">
                    <option value="<?php echo $ketqua['idthu']?>" disabled selected><?php echo $ketqua['thumay']?></option>
                    <?php
            ...
            <label>Tiết học</label>
                <select id="inputState" class="form-control" name ="tiethoc">
                    <option value="<?php echo $ketqua['idtiethoc']?>" disabled selected><?php echo $ketqua['TietHoc']?></option>
                    <?php
            ...
            <label>Phòng học</label>
                <select id="inputState" class="form-control" name ="phong">
                    <option value="<?php echo $ketqua['idphong']?>" disabled selected><?php echo $ketqua['SoPhong']?></option>
                    <?php
